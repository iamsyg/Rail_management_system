...
export default function Signup() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.phoneNumber.trim()) {
      ...
      newErrors.phoneNumber = 'Please use international format (+1234567890)';
    }
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className={`mt-1 appearance-none block w-full px-3 py-2 border ${errors.name ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
              />
